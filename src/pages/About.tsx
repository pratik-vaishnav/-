              ...
              <CardContent className="p-0">
                ...
                <div className="prose prose-lg max-w-none text-gray-700">
                  ...
                  <p className="mb-4">
                    ...
                    Employee of the Month three times and receiving the BIAS
                    Award has been incredibly motivating, but what drives me
                    most is the impact our solutions have on real businesses.
                  </p>
                  <p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Recognized for upholding core values (Belief,
                          Integrity, Accountability, Sincerity) while leading
            ...
            <Card className="p-8 text-center bg-gradient-to-r from-primary-600 to-accent text-white">
              <CardContent className="p-0">
                ...
                <p className="text-lg opacity-90 mb-6 max-w-2xl mx-auto">
                  ...
                  knowledge, or collaborate on interesting projects. Feel free
                  to reach out!
                </p>

          ...
          <Card className="p-8 text-center border-2 border-dashed border-primary-200">
            <CardContent className="p-0">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                ...
                including technical architecture, challenges solved, performance
                improvements, and business impact. Many projects are
                enterprise-level and require proper documentation before
                sharing.
              </p>
